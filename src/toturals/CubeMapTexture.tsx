...
export const CubeMapTexture = () => {
    ...
    useEffect(() => {
        ...
        (async () => {
            ...
            textureArray.push(cubeMapTexture);
            ...
            function render() {
                ...
                (device as GPUDevice).queue.writeBuffer(uniformBuffer, 0, uniformValues);
